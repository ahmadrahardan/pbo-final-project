...
{
    public partial class mUserControlStok : UserControl
    {
        mLandingPage FormParent;
        FlowLayoutPanel panelKatalog;
        public mUserControlStok(mLandingPage FormParent)
        {
            InitializeComponent();
        ...
        private void AddKatalogCard(mKatalog katalog)
        {
            ...
            plusBox.Click += (object sender, EventArgs e) =>
            {
                ...
                try
                {
                    mStokContext.UpdateStok(katalog.id_katalog, katalog.Stok);
                }
                catch (Exception ex)
                {
        ...
        private void mUserControlStok_Load(object sender, EventArgs e)
        {
