...
{
    public partial class mUserControlLogin : UserControl
    {
        mLandingPage FormParent;
        public mUserControlLogin(mLandingPage FormParent)
        {
            InitializeComponent();
        ...
        {
            mLoginContext loginMitraContext = new mLoginContext();
            mLogin login = loginMitraContext.Validate(EmailBox.Text, PasswordBox.Text);
        ...
        private void mUserControlLogin_Load(object sender, EventArgs e)
        {
